...
char	**ft_convert_each_word_start_to_lowercase(char **words, short *word_index)
{
	short	c;
...
int	main(void)
{
	...
	words = ft_convert_each_word_start_to_lowercase(words, word_index);
	printf("Words in the sentence which starting with lower_case:\n");

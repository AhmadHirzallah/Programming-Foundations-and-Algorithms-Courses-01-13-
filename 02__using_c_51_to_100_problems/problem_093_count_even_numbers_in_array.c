...
void	ft_copy_array_even_elements_to_another(int i_array[100], int i_array2[100], short array1_len, short *array2_len);
...
short	*ft_count_even_nbrs_in_array(int i_array[100], short   *i_entered_len);
t_e_even_or_even	*ft_e_p_check_nbr_even_or_even(int *p_i_entered_nbr);
...
t_e_even_or_even	*p_e_even_or_not;
short	*p_even_count;
...
int	main(int argc, char **argv)
{
	...
	p_e_even_or_not = (t_e_even_or_even *)ft_malloc(1, sizeof(t_e_even_or_even));
	i_entered_len = 0;
	p_i_generated_random_nbr = ft_malloc(1, sizeof(int));
	p_even_count = ft_malloc(1, sizeof(short));
	...
	printf("\n");
	p_even_count = ft_count_even_nbrs_in_array(i_array, &i_entered_len);
	ft_print_result("The count of even numbers is: ", p_even_count);
	free(p_i_generated_random_nbr);
	free(p_e_even_or_not);
	free(p_even_count);
	free(from);
	free(to);
	return (0);
...
short	*ft_count_even_nbrs_in_array(int i_array[100], short   *i_entered_len)
{
	...
	*p_even_count = 0;
	...
	{
		p_e_even_or_not = ft_e_p_check_nbr_even_or_even(&i_array[index]);
		if (*p_e_even_or_not == even)
			(*p_even_count)++;
	}
	return (p_even_count);
}
...
t_e_even_or_even	*ft_e_p_check_nbr_even_or_even(int *p_i_entered_nbr)
{
	...
	{
		*p_e_even_or_not = even;
		return (p_e_even_or_not);
	}
	*p_e_even_or_not = odd;
	return (p_e_even_or_not);
}

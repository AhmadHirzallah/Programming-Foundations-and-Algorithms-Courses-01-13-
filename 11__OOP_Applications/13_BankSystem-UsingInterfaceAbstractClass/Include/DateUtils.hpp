...
class	DateUtils
{
	public:
				...
				DateUtils(short day, short month, int year, short hours, short minutes, short seconds)
				{
					this->_day = day;
					this->_month = month;
					this->_year = year;
				...
				static DateUtils	getSystemDateAndTime()
				{
					short day, month,	 hours, minutes, seconds;
					int year;
					...
					return (DateUtils(day, month, year, hours , minutes, seconds));
				}


				static std::string	getSystemDateAndTimeStr()
				{
					DateUtils DateObj = getSystemDateAndTime();
					
					return (std::to_string(DateObj.getDay()) + "/" + std::to_string(DateObj.getMonth()) + "/" + 
							std::to_string(DateObj.getYear()) 	+ 	" - " +\
							std::to_string(DateObj.getHours()) + ":" + std::to_string(DateObj.getMinutes()) + ":" +
							std::to_string(DateObj.getSeconds()));
				}

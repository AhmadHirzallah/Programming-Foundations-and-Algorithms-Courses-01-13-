...
void    ft_display_calendar_of_month(t_date entered_date)
{
...
void	ft_read_year_and_display_calendar_of_months()
{
	t_date entered_date;
    ...
    printf("\t\tCalendar -- %hd\n", entered_date.year);
    printf("_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-__-_-_-\n\n");
    entered_date.day = 1;
	entered_date.month = 0;
	while (++(entered_date.month) <= 12)
	{
		ft_display_calendar_of_month(entered_date);
		printf("\n~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n");
		printf("\n~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n");
	}
}
...
int	main ()
{
	ft_read_year_and_display_calendar_of_months();
	return (0);
}

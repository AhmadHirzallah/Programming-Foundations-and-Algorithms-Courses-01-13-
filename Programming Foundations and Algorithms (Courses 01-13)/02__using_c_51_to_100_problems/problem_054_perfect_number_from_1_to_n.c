...
void	ft_print_perfect_nbr_from_1_to_n(int  *p_i_entered_nbr);
...
int	main(int argc, char **argv)
{
	...
	*p_i_entered_nbr = atoi(argv[1]);
	ft_print_perfect_nbr_from_1_to_n(p_i_entered_nbr);
...
void	ft_print_perfect_nbr_from_1_to_n(int  *p_i_entered_nbr)
{
	...
	if (!p_i_counter)
		return;
	*p_i_counter = 0;
	while (++(*p_i_counter) <= (*p_i_entered_nbr))
	{
		ft_print_perfect_nbr_result(p_i_counter);
	}
}

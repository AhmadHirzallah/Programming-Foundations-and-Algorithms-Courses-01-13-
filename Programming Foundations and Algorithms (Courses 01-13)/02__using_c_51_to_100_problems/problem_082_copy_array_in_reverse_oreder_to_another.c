...
void	ft_copy_array_elements_in_reverse_order_to_another(int i_array[100], int i_array2[100], short entered_len);
...
int	main(int argc, char **argv)
{
	...
	ft_copy_array_elements_in_reverse_order_to_another(i_array, i_array2, entered_len);
...
void	ft_copy_array_elements_in_reverse_order_to_another(int i_array[100], int i_array2[100], short entered_len)
{
	...
	while (c < entered_len)
	{
		...
		i_array2[c] = i_array[entered_len - 1 - c];
		c++;
	}
}

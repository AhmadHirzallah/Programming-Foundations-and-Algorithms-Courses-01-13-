...
int main(int argc, char *argv[]) 
{
	...
	negative_nbrs_count = 0; 
	arr_len = atoi(argv[1]);
	ft_fill_array_with_random_nbrs();
	negative_nbrs_count = ft_get_negative_count();
	ft_print_array_elements();
	printf("Negative Numbers count is: (%hd)\n\n", negative_nbrs_count);
	return (0);
}

...
class	InputValidator
{
	public:
			...
			static std::string	readString(std::string AskString = "")
			{
				std::string Input;
			...
			static char	readChr(std::string AskChr = "")
			{
				char	Input;
			...
			static T readPositiveNumber_Var(std::string AskNbr = "Please enter a positive number: ", 
											std::string error_message = "Invalid entered number, enter again: ")
			{
				T number;

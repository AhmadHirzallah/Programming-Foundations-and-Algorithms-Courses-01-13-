...
void    ListOneClient(clsBankClient &Client)
{
...
short   inputReadingClientInfo(clsBankClient &Client)
{
    ...
    std::cout <<"\n\nPlease if you want to proceed enter (y):  ";
    std::cin >> proceed_fl;
...

{
    ...
    //      To Total Balances Of Clients:
    ShowTotalBalancesOfClients();




    //      To List All Clients on the system
    // ShowClientsList();


    //      To Delete an Exist Client from the DataFiles :
    // DeleteClient();


    //      To Add new client to the file
    // AddNewClient();


    //      To Update Client Using the Exist ID Number
    // UpdateClient();


    //      Show MainMenu Before Connecting UI With Logical Layer
